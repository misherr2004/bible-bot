...
**Альтернатива:** если не хочешь возиться с Oracle, можно взять самый дешёвый VPS (например Hetzner ~4 €/мес или российские провайдеры) — это уже платно, но дёшево.

---

## Деплой на отдельный сервер

Нужен VPS с Linux (Ubuntu/Debian): Oracle Cloud (бесплатно, см. выше), DigitalOcean, Timeweb, Selectel и т.п.
